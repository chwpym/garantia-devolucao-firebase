...
const navItems = {
  ...
  register: { id: 'register', label: 'Cadastro de Garantia', icon: PlusSquare },
  query: { id: 'query', label: 'Consulta de Garantias', icon: Search },
  lotes: { id: 'lotes', label: 'Lotes de Garantia', icon: Package },
    ...
    return (
        <div className={className}>
            <nav className="flex flex-col gap-1 px-4">
                ...
                {renderNavItem(navItems.register)}
                {renderNavItem(navItems.query)}
                {renderNavItem(navItems.lotes)}
