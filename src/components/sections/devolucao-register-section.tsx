                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                                          <FormField
                                              ...
                                              <FormItem className="md:col-span-3">
                                                ...
                                                <Popover open={activeProductSearch?.index === index} onOpenChange={(isOpen) => {
                                                    if (!isOpen) setActiveProductSearch(null);
                                                }}>
                                                    ...
                                                    <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
                                                        <Command>
                                                            <CommandInput 
                                                                ...
                                                                onValueChange={(q) => setActiveProductSearch({ index, query: q })}
                                                            />
                                                            <CommandList>
                                                                <CommandEmpty>
